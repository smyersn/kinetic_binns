Physics-informed neural networks (PINNs) have been adopted by biologists for 
...
laws to the surface. Eventually, this work will be extended to learn reaction-diffusion equations from experimental data.
