...
class BINN(nn.Module):
    ...
    def __init__(self, dimensions, species, duplicates=1, data=None, 
                 diff_coeffs=None, degree=2, l05_reg=0, l1_reg=0, param_bounds=10):
    ...
    def pde_loss(self, inputs, outputs):
        ...
        # uxx_array = torch.zeros((self.species, rows, self.dimensions)).to(inputs.device)
        # ut_array = torch.zeros((rows, self.species)).to(inputs.device)
